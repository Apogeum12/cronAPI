...
/// Represents the details of services that are intended to run on specified threads.
///
/// This struct contains information about the number of threads and the specific
/// services or tasks that are scheduled to run on them.
#[derive(Deserialize, Clone)]
pub struct RunScrapers {
    /// The number of threads to run the scrapers on.
    pub thread: i16,
    /// A list of services or tasks that need to run.
...
/// scheduled time, the thread number, and the specific tasks associated with it.
